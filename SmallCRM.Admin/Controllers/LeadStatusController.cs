...
namespace SmallCRM.Admin.Controllers
{
    public class LeadStatusController : Controller
    {
        ...
        {
            var leadStatues = Mapper.Map<IEnumerable<LeadStatusViewModel>>(leadStatusService.GetAll());
        ...
        public ActionResult Details(Guid? id)
        {
            ...
            LeadStatusViewModel leadStatus = Mapper.Map<LeadStatusViewModel>(leadStatusService.Get(id.Value));
            if (leadStatus == null)
            {
                return HttpNotFound();
            }
